...
description: "Production-grade Model Context Protocol server that connects LibreChat, LobeChat, and Claude Desktop directly to your self-hosted Actual Budget. 71 tools, two transports, multi-budget switching at runtime."
category: "AI/MCP"
tier: 1
status: "active"
...
featured: true
metrics: "71 tools | 87% API coverage | Production-ready"
