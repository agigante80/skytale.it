...
stats:
  - value: "2"
    label: "Live sites running on it"
    sub: "galena.es and ondahertz.es"
  - value: "2"
    label: "Content shapes supported"
    sub: "Standard posts and affiliate products"
  - value: "3"
    label: "Search-engine notifiers"
    sub: "IndexNow endpoints pinged on publish"
quickstart:
